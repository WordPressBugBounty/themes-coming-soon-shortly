...
if ( ! class_exists( 'Coming_Soon_Shortly_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Coming_Soon_Shortly_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Coming_Soon_Shortly_WPTT_WebFont_Loader( $url );
