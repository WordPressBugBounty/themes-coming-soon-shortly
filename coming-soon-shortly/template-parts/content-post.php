...
<div id="post-<?php the_ID(); ?>" <?php post_class('post-single mb-4'); ?>>
  ...
  <div class="post-info my-2">
    <?php if( get_theme_mod( 'coming_soon_shortly_single_post_date_hide',true)) : ?>
    ...
    <?php endif; ?>
    <?php if( get_theme_mod( 'coming_soon_shortly_single_post_author_hide',true)) : ?>
    ...
    <?php endif; ?>
    <?php if( get_theme_mod( 'coming_soon_shortly_single_post_comment_hide',true)) : ?>
  ...
  <div class="post-content">
    <?php the_content(); ?>
    <?php if( get_theme_mod( 'coming_soon_shortly_single_post_tag',true)) : ?>
      <?php the_tags('<div class="post-tags"><strong>'.esc_html__('Tags:','coming-soon-shortly').'</strong> ', ', ', '</div>');?>
    <?php endif; ?>
    <?php if( get_theme_mod( 'coming_soon_shortly_single_post_category',true)) : ?>
      <div class="single-post-category mt-3">
    		<span class="category"><?php esc_html_e('Categories:','coming-soon-shortly'); ?></span>
    			<?php the_category(); ?>
    	</div>
    <?php endif; ?>
  </div>
